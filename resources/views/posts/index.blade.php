...
@section('content')
   ...
   <div class="row align-items-center">
      <div class="col-md-6">
         <div class="mb-3">
            <h5 class="card-title">Daftar Post <span class="text-muted fw-normal ms-2">({{ $posts->count() }})</span></h5>
         </div>
      </div>
      ...
      <div class="col-md-6">
         <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
            <div>
               <a href="{{ route('index') . '/api/post' }}" class="btn btn-danger"><i class="bx bx-detail me-1"></i> API </a>
               <a href="{{ route('post.create') }}" class="btn btn-primary"><i class="bx bx-plus me-1"></i> Add New</a>
            </div>
         </div>
                     ...
                     <tbody>
                        @foreach ($posts as $key => $post)
                           <tr>
                              ...
                              <td>{{ $post->alamat }}</td>
                              <td>
                                 <a class="badge rounded-pill badge-soft-success" href="{{ route('post.edit', $post) }}">
